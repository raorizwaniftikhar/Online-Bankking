...
$result ="";
$result = mysql_query("select account_type from fixed_account ORDER BY account_type");
if(isset($_POST['Submit'])) ///forsubmit data           
{
$acc_type=$_POST['acc_type'];
$delres=mysql_query("delete from fixed_account where account_type=\"$acc_type\"");

if($delres==1)
{
echo "Account Deleted Successfully";
echo "<p>Click <a href='admin_acc_view_deposits.php'> here </a> to delete another";
exit(0);
}
}
?>
