...
if ($subject=="")
{
echo "Subject Is Not Must Be Empty...";
}
elseif($complaint=="")
{
echo "Message Is Not Must Be Empty...";
}

else 
{ 
if(mysql_query("Insert into complaint(comp_to,comp_from,subject,complaint,comp_date) values('".$to."','".$from."','".$subject."','".$complaint."','".$comp_date."')"))
{
...
print "</select>";
?></td></tr></p>
<p align=center><tr><td><font size=4>From &#160;&#160;&#160;&#160;&#160;:</font> </td><td><font size=4>&#160;&#160;&#160;Administrator</font></td></tr>
</p>
