...
$delres=mysql_query("delete from accounts where acc_type=\"$acc_type\"");

if($delres==1)
{
echo "Account Deleted Successfully";
echo "<p>Click <a href='admin_del_acc.php'> here </a> to delete another";
exit(0);
}
}
?>
...
<div align="center">Select the Account to be deleted !</div>
</TD>              
</TR>              
<TR>                
...
<select name="acc_type"  id="username2"   tabindex="1">
...
<div align="center">            <p>              
<input name="Submit" type="submit" class="admin_add_items" value="Delete Account">
&#160;&#160;&#160;&#160;          
<input name="Submit2" type="button" class="admin_add_items" id="Submit2" onClick="location.replace('./admin_acc_view.php')" value="Cancel" ></p>    <p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>      
</div>           
</form>           </DIV> 
</TD>  
</TR>  
