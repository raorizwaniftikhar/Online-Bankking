...
{			       
if (!eregi ("^[0-9 ]+$", stripslashes(trim($minbalance))))  //Accept characters only				      
{					    
echo "Enter Valid Data for Last Name!";echo "<p>Click <a href='admin_updt_acc_data.php'> here </a> to go back";				        exit(0);					  					  
}				 			 				 			
else 
{ 
