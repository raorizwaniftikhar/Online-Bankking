...
//else 
//{ 
if(mysql_query("Insert into complaint(comp_to,comp_from,subject,complaint,com_date) values('".$to."','".$from."','".$subject."','".$complaint."','".$com_date."')"))
{
...
<p align=center>TO:<select  name="to" AUTOCOMPLETE="ON" tabindex="1" >	
<?php 
...
print "</select>";
?></p>
<p align=center>From:<input type="text"  name="from" Value="Administrator" >	
</p>
<p align=center>subject:<input type="text" name="subject"> <br><br></p>
<p align=center>
Alert : <br>	<textarea name="complaint"  rows=10 col=20></textarea></p>
