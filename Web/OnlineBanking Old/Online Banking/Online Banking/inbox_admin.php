...
<br>
<input name="Submit2" type="button" class="admin_add_items" id="Submit2" onClick="location.replace('./admin_data.php?mode=admin')" value="<< Back" >&#160;&#160;&#160;

<input name="replay" type="submit" class="admin_add_items" id="reply" value="Replay" >&#160;&#160;&#160;

<input name="delete" type="submit" class="admin_add_items" id="delete" value="Delete" >&#160;&#160;&#160;
