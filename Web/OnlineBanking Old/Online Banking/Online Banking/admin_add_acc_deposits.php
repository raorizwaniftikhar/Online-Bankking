...
echo "<p>Click <a href='admin_add_acc_deposits.php'> here </a> to go back";			  
exit(0);				 
}			
else 
{			       
...
{					    
echo "Enter Valid Data for Minimum Balance!...";
echo "<p>Click<a href='admin_add_acc_deposits.php'>here </a> to go back";			exit(0);					  					  
}				 			
else 
{  
$result = mysql_query("Insert into fixed_account  values('".$acc_type."','".$minbalance."')");                    
 $db_close=mysql_close();			 
if ($result )		
{	
echo "Added To The Database...";
echo "<p>Click <a href='admin_add_acc_deposits.php'> here </a> to add another";
...
echo "<p>Click <a href='aadmin_add_acc_deposits.php'> here </a> to go back";	
exit(0);			  
} 					
}		     
}
