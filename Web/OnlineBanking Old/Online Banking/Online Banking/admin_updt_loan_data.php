...
{				  
echo "Enter Valid Data for Loan Type!";				  
exit(0);				 
}			
else 
{			       
if (!eregi ("^[0-9 ]+$", stripslashes(trim($duration))))  //Accept characters only				      
{					    
echo "Enter Valid Data for Last Name!";echo "<p>Click <a href='admin_updt_loan_data.php'> here </a> to go back";				        exit(0);					  					  
}				 			 				 			
else 
{ 
$del=mysql_query("delete from loan_type where loan_type='$loan_type'"); 
$result = mysql_query("Insert into loan_type  values('".$loan_type."','".$duration."','".$amount."')");                     
$db_close=mysql_close();            			 
if ($result )			    
{				 
echo "Data Updated Successfully";
echo "<p>Click <a href='admin_updt_loan.php'> here </a> to update another";
exit(0);								 
}			 
else			  
{		
echo "Updation Failure";echo "<p>Click <a href='admin_updt_loan_data.php'> here </a> to go back";
exit(0);			  } 									  
}		   		     
}		 			 
}	 
