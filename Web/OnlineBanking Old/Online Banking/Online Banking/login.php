          ...
          <TABLE width="45%" height="30%" border=4 align=center cellPadding=5 cellSpacing=0 t id="rt">
            ...
            <TBODY>
              ...
              <TR>
                ...
                <TD width="67%" align=left class=firstalt><input name="username" type="text"  id="username"  maxlength="20" size="20" tabindex="1">
                </TD>
              </TR>
              <TR>
                <TD class=secondalt align=middle><span class="style16">Password :</span><BR>
                </TD>
                <TD class=secondalt align=left><input name="password" type="password"  id="password2"  maxlength="20" size="20" AUTOCOMPLETE="OFF" tabindex="2" ></TD>
              </TR></TBODY></TABLE>
<p align=center><font color=red>Forgotten Password ? <a href='forgotten.php'>Click here...</a></font></p>
          <p align="center">
