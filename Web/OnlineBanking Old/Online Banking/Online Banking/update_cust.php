...
<FONT face="Verdana, Arial, Helvetica, sans-serif" color=#aaeeff size=2>| Update Customer </FONT>
</STRONG>
...
{
echo "<form name=\"Form1\" method=\"post\" action=\"updt_delet.php?mode=teller\">";
}
else
{
