...
?>
<FONT face="Verdana, Arial, Helvetica, sans-serif" color=#ffffff size=2>Home 
</FONT>
</STRONG>
</TD>    
</TR>        
...
<input name="Submit2" type="button" class="admin_add_items" id="Submit2" onClick="location.replace('./mini_st_teller.php')" value="Back" > 
<input name="Submit2" type="button" class="admin_add_items" id="Submit2" onClick="location.replace('./teller_data.php')" value="Cancel" >       
</p><p>&nbsp;</p>        
<p>&nbsp;</p>        
<p>&nbsp;</p>        
<p>&nbsp;</p>        
