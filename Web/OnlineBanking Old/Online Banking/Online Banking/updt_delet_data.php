...
//checkanemailaddressispossiblyvalidhttp://www.zend.com/zend/spotlight/ev12apr.php
...
$result=mysql_query("update customer set first_name='".$first_name."',last_name='".$last_name."',address='".$address."',email='".$email."',country='".$con."',contact_number='".$contact_number."',acc_number='".$acc_number."',balance='".$balance."'  WHERE custid='". $custid . "'");
