...
<th width="50"><span class="style6">Open date </span></th>
...
<br><br>
<input name="Submit2" type="button" class="admin_add_items" id="Submit2" onClick="location.replace('./teller_data.php')" value="<< Back" ></div> 
</TD></TR>
</TBODY>
</TABLE>
</body>
