...
if($modes=='teller')
{
echo "<form name=\"Form1\" method=\"post\" action=\"searchres_teller.php?mode=teller\">";
}
?>          
<p>&nbsp;</p>          
...
&#160;&#160;&#160;&#160;          
<input name="Submit2" type="button" class="admin_add_items" id="Submit2" onClick="location.replace('./teller_data.php')" value="<< Back" ></div> </p>      
</form>           
</DIV>
</TD>    
</TR>  
