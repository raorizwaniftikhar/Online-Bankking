...
color=#ffffff size=2><center>EMI</center> </FONT></STRONG></TD>
 ...
 <TR>
<TD width=738 background="4.gif"  height=1><div align="justify"><STRONG><a href="emi.php?mode=admin"><FONT face="Verdana, Arial, Helvetica, sans-serif" 
...
echo " <center>Amount = $amount </center><br>";

echo " <center>Interst =$interst </center><br>";

echo" <center>Payment =$payment </center><br>";

echo "<center>Total Amount = $total </center><br>";

echo"<center>montly =$monthly</center>";
}
