...
<DIV align=right>                       
<form name="Form1" method="post" action="updt_delet_data.php" onSubmit="return Blank_TextField_Validator()">          
<p>&nbsp;</p>          
...
<TABLE width="65%" height="30%" border=3 align=center cellPadding=3 cellSpacing=0 class=rt id="rt">            <TBODY>              <TR>                <TD class=sectionhead align=middle colSpan=2><div align="center">Enter The Customer Details Below  !</div></TD>              
</TR>              
<TR>                
...
print " <TD width=\"59%\"align=left class=secondalt>"; 
...
print " class=\"style2\">";print "<B>Sex &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;:</B><BR></div></TD>";
print "<TD width=\"59%\"align=left class=secondalt>"; 
...
<br><br>
<div> <input name="Submit2" type="button" class="admin_add_items" id="Submit2" onClick="location.replace('./search_teller.php?mode=teller')" value="<< Back" ></div> 
