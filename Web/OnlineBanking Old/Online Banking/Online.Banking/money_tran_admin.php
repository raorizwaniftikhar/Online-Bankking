...
$cust1=mysql_query("select user_name from login where  user_name!='admin' order by user_name");
...
<p align=center>FROM:<select  name="From" AUTOCOMPLETE="ON" tabindex="1"> </p>

 <option> </option>
<?php

while($custid1 = mysql_fetch_array($cust1, MYSQL_BOTH))
{
print "<option>".$custid1[0]."</option>";
}
print "</select>";
?>
