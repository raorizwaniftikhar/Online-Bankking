...
<FONT face="Verdana, Arial, Helvetica, sans-serif" size=2><center>EMI</center> </FONT></STRONG></TD>
 </TR>
 <TR>
<TD width=738 background="images/top_2.gif"  height=9><div align="justify"><a href="loan2.php">
	...
	<b>
	<font size="5" face="Verdana, Arial, Helvetica, sans-serif" color="#000000">Home 
	</font><font size="5" color="#000000">
</STRONG></font></b></TABLE>
<form  action="loan1.php" method="post">
<p align="center"><b>Loan Amount :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</b> <input name="loan_amount" size="36" style="font-weight: 700" ><b> <br>
<br>

Interest Rate:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</b><input name="interst" size="37" style="font-weight: 700" ><b> <br>
<br>

Number Of Payment&nbsp; </b>
<input name="payment" size="37" style="font-weight: 700" ><b> <br>
<br>
