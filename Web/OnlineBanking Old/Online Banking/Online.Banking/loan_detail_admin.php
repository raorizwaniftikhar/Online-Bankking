...
$result = mysql_query("Select * from loan_accept",$link) or die("Database Error");
...
<tr>
 ...
 <th width="50"><span class="style6">Loan Type </span></th>

 <th width="5"><span class="style6">Duration </span></th>
 <th width="10"><span class="style6">Start Date</span></th>
<th width="60"><span class="style6">Amount</span></th>

<th width="50"><span class="style6">Monthly Payment </span></th>
...
<br><br>
<input name="Submit2" type="button" class="admin_add_items" id="Submit2" onClick="location.replace('./loan3.php')" value="<< Back" ></div> 
</TD></TR>
</TBODY>
</TABLE>
</body>
