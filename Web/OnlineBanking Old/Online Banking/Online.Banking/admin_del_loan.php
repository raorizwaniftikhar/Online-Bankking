...
$result ="";
$result = mysql_query("select loan_type from loan_type ORDER BY loan_type");
if(isset($_POST['Submit'])) ///forsubmit data           
{
$loan_type=$_POST['loan_type'];
$delres=mysql_query("delete from loan_type where loan_type=\"$loan_type\"");

if($delres==1)
{
echo "Account Deleted Successfully";
echo "<p>Click <a href='admin_del_loan.php'> here </a> to delete another";
exit(0);
}
}
?>
...
<div align="center">Select the Loan to be deleted !</div>
</TD>              
</TR>              
<TR>                
<TD class=firstalt align=middle width="41%">
<div align="left" class="style1">Loan Type :</div>
</TD>                

<TD width="59%" align=left class=firstalt>
<select name="loan_type"  id="username2"   tabindex="1">
...
<div align="center">            <p>              
<input name="Submit" type="submit" class="admin_add_items" value="Delete Loan">
&#160;&#160;&#160;&#160;          
<input name="Submit2" type="button" class="admin_add_items" id="Submit2" onClick="location.replace('./loan3.php')" value="Cancel" ></p>    <p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>      
</div>           
</form>           </DIV> 
</TD>  
</TR>  
