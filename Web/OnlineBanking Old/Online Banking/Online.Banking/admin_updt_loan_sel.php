...
$result ="";
$result= mysql_query("select * from loan_type where loan_type='$loan_type'");	    
...
<DIV align=right>                       
<form name="Form1" method="post" action="admin_updt_loan_data.php" >          <p>&nbsp;</p>          
...
<input";print " name=loan_type type=\"text\"";
...
print " print name=duration type=\"text\"";
print " value=$row[1] tabindex=\"1\"></TD></TR><TR>";

print " </TR><TR><TD class=secondalt align=middle><div align=\"left\"";
print " class=\"style2\"><B>Amount :</B><BR></div></TD>";
print " <TD width=\"59%\"align=left class=firstalt><input"; 
print " print name=amount type=\"text\"";
print " value=$row[2] tabindex=\"1\"></TD></TR><TR>";
...
&#160;&#160;&#160;&#160;          
<input name="Submit2" type="button" class="admin_add_items" id="Submit2" onClick="location.replace('./admin_updt_loan.php')" value="<< Back" ></div>
</form>                     
</DIV>
</TD>    
</TR>  
