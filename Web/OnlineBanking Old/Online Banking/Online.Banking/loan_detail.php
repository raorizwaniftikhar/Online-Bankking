...
include 'db_connect.php';
 $custid1=$_SESSION['username'];

$result = mysql_query("Select * from loan_accept where cust_id='$custid1'",$link) or die("Database Error");
...
<tr>
 <th width="50"><span class="style6"><font color="#000000">Loan Id</font></span></th>
 <th width="50"><span class="style6"><font color="#000000">Loan Type </font> </span></th>

 <th width="5"><span class="style6"><font color="#000000">Duration </font> </span></th>
 <th width="10"><span class="style6"><font color="#000000">Start Date</font></span></th>
<th width="60"><span class="style6"><font color="#000000">Amount</font></span></th>

<th width="50"><span class="style6"><font color="#000000">Monthly Payment </font> </span></th>
...
<br><br>
<font color="#000000">
<input name="Submit2" type="button" class="admin_add_items" id="Submit2" onClick="location.replace('./loan2.php')" value="<< Back" ></font></div> 
</TD></TR>
</TBODY>
</TABLE>
</body>
