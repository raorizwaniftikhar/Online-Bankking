...
<DIV align=right>                       
<form name="Form1" method="post" action="admin_updt_loan_sel.php">          
<p>&nbsp;</p>          
...
<TBODY>              
<TR>                
<TD class=sectionhead align=middle colSpan=2><div align="center">Select the Loan Type to fetch details !</div>
</TD>              
</TR>              
<TR>                
<TD class=firstalt align=middle width="41%"><div align="left" class="style1">Loan Type :</div></TD>                
<TD width="59%" align=left class=firstalt>

<select name="loan_type"    tabindex="1">
