...
mysql_query("update interest set old_bal=$updateamount where cust_id=$custid");
...
echo "<p>Click <a href='tran_teller.php?mode=$dmode'> here </a> for another transaction";exit(0);				 
}			 
else			  
{			      
echo "Transaction failure";
echo "<p>Click <a href='tran_do_teller.php?mode=$dmode'> here </a> to go back";			  
} 
exit(0);
}
...
<input name="Submit2" type="button" class="admin_add_items" id="Submit2" onClick="location.replace('./tran_teller.php')" value="Cancel" ></div> </p>
...
{
echo "Please click here to login " . "<a href=teller_data.php>Login Page</a>";
}
?>