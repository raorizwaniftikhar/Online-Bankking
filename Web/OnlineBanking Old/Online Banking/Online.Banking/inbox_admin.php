...
if(isset($_POST['delete'])) ///forsubmit data           
{
 ...
 for($i=0;$i<$count;$i++)
 {
//echo  $strExpert="$strExpert.$check[$i], ";
echo  $strExpert = $check[$i];
mysql_query("delete from complaint where slno='".$strExpert."'") or die("Database Error");
 }
...
//{
//mysql_query("delete from complaint where slno='".$_POST['check']."'") or die("Database Error");
//}
...
<body>
<form action="inbox_admin.php" method="post">
...
<br>
<font color="#000000">
<input name="Submit2" type="button" class="admin_add_items" id="Submit2" onClick="location.replace('./admin_data.php?mode=admin')" value="<< Back" ></font>&#160;&#160;&#160;

<font color="#000000">

<input name="replay" type="submit" class="admin_add_items" id="reply" value="Replay" ></font>&#160;&#160;&#160;

<font color="#000000">

<input name="delete" type="submit" class="admin_add_items" id="delete" value="Delete" ></font>&#160;&#160;&#160;

<font color="#000000">

<input name="deleteall" type="submit" class="admin_add_items" id="deleteall" value="Delete All" ></font>&#160;&#160;&#160;
