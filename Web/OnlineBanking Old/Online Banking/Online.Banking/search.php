...
<FONT face="Verdana, Arial, Helvetica, sans-serif" color=#0000FF size=5><u>Home</u> </FONT>
</STRONG>
</TD>    
</TR>     
<TR>      
...
if($modes=='admin')
{
echo "<form name=\"Form1\" method=\"post\" action=\"searchres.php?mode=admin\">";
}
else if($modes=='teller')
{
echo "<form name=\"Form1\" method=\"post\" action=\"searchres.php?mode=teller\">";
}
else
{
echo "<form name=\"Form1\" method=\"post\" action=\"searchres.php?mode=cust\">";
}
?>          
<p>&nbsp;</p>          
...
<TABLE width="65%" height="30%" border=3 align=center cellPadding=3 cellSpacing=0 class=rt id="rt">            <TBODY>              
<TR>                
...
&#160;&#160;&#160;&#160;          
<input name="Submit2" type="button" class="admin_add_items" id="Submit2" onClick="location.replace('./admin_data.php')" value="<< Back" ></div> </p>      
</form>           
</DIV>
</TD>    
</TR>  
