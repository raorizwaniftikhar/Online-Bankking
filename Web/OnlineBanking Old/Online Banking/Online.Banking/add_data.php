...
mysql_query("Insert into interest(acc_num,date,old_bal) values('".$acc_number."','".$d."','".$balance."')");
...
$result = mysql_query("Insert into customer values('".$custid."','".$first_name."',
			'".$last_name."','".$age."','".$address."','".$country."','".$email."','".$sex."','".$contact_number."','".$acc_number."','".$balance."','".$acc_type."','".$opendate."')");
...
<FONT face="Verdana, Arial, Helvetica, sans-serif" 
      color=#000080 size=2>Home </FONT>
<a href='add_data.php?mode=admin'>
<FONT face="Verdana, Arial, Helvetica, sans-serif" color=#000080 size=2>
	<span style="text-decoration: none">| Create Customer </span> </FONT>
<a href='update_cust.php?mode=admin'>
<FONT face="Verdana, Arial, Helvetica, sans-serif" color=#000080 size=2>
	<span style="text-decoration: none">| Update Customer </span> </FONT>
<a href='admin_cust_del.php?mode=admin'>
<FONT face="Verdana, Arial, Helvetica, sans-serif" color=#000080 size=2>
	<span style="text-decoration: none">| Delete Customer </span> </FONT>
	</STRONG>
...
?>
  ...
  <TR>
   ...
   <TR><TD class=secondalt align=middle><div align="left" class="style2"><B>Age</B><BR>
                </div></TD>
<TD width="59%" align=left class=firstalt><input name="age" type="text"  id="age"  maxlength="40" size="40" tabindex="2"></TD>
</tr><tr>
  ...
  <TR>
                <TD class=secondalt align=middle width="41%"><div align="left" class="style1">Country :</div></TD>
<TD class=secondalt align=left>
<select name=country>
 <option>INDIA</option>
 <option>CHINA</option><option>USA</option><option>LONDON</option><option>MALAYSIA</option><option>U.K</option>
</select></td>
<TR>
              <TR>
...
&#160;&#160;&#160;&#160;          
<input name="Submit2" type="button" class="admin_add_items" id="Submit2" onClick="location.replace('./customer_accounts.php')" value="Cancel" ></div> </p>
        </form>
