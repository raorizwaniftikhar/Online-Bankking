...
$rectrans=mysql_query("select * from transactions where trans_id='$_GET[trid]'");
$recs = mysql_fetch_array($rectrans);

$rectransa=mysql_query("select * from registered_payee where account_no='$recs[receiver_id]'");
